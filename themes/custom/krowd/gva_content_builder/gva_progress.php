...
if(!class_exists('element_gva_progress')):
   class element_gva_progress{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $_classes = count($class_array) > 0 ? implode(' ', $class_array) : '';
          ob_start();
         ?>
         <div class="widget gsc-progress <?php print $_classes ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
            <h3 class="progress-label"><?php print $title ?></h3>
             <div class="progress">
