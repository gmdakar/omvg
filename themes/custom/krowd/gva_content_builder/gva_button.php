...
if(!class_exists('element_gva_button')):
   class element_gva_button{
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'options'   => array(
                        ...
                        'btn-theme-second'   => 'Button Second' 
                  ),
                  'std'       => 'text-dark'
               ),
               array(
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <a href="<?php print $link ?>" class="<?php  print $_classes ?>" id="<?php print $_id; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
            <?php print $title ?>
         </a> 
