...
if(!class_exists('element_gva_our_team')):
   class element_gva_our_team{
      ...
      public static function render_content( $attr = array(), $content = '' ){
                        ...
                        <div class="box-hover">
                           <div class="content-inner">
                              <div class="social-list text-center">
                                 <?php if($facebook){ ?>
                                    <a href="<?php print $facebook ?>"><i class="fab fa-facebook-square"></i> </a>
                                 <?php } ?>
                                 <?php if($twitter){ ?>   
                                    <a href="<?php print $twitter ?>"><i class="fab fa-twitter"></i> </a>
                                 <?php } ?>
                                 <?php if($pinterest){ ?>   
                                    <a href="<?php print $pinterest ?>"><i class="fab fa-pinterest-p"></i> </a>
                                 <?php } ?>
                                 <?php if($google){ ?>   
                                    <a href="<?php print $google ?>"> <i class="fab fa-google-plus-g"></i></a>  
                                 <?php } ?>                                             
                              </div>  
                           </div>   
                        </div>
         ...
         if($style=='vertical'){ ?>
            <div class="widget gsc-our-team team-vertical <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="widget-content">
                  ...
                  <div class="team-body text-<?php print $content_align; ?>">
                     ...
                     <div class="social-list">
                        <?php if($facebook){ ?>
                           <a  href="<?php print $facebook ?>"><i class="social-icon fab fa-facebook-square"></i> </a>
                        <?php } ?>
                        <?php if($twitter){ ?>   
                           <a  href="<?php print $twitter ?>"><i class="social-icon fab fa-twitter"></i> </a>
                        <?php } ?>
                        <?php if($pinterest){ ?>   
                           <a  href="<?php print $pinterest ?>"><i class="social-icon fab fa-pinterest-p"></i> </a>
                        <?php } ?>
                        <?php if($google){ ?>   
                           <a  href="<?php print $google ?>"> <i class="social-icon fab fa-google-plus-g"></i></a>  
                        <?php } ?>                                          
                     </div>            
                  </div>                            
               </div>
         ...
         //circle
         if($style=='circle'){ ?>
            <div class="widget gsc-team team-vertical team-circle <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
