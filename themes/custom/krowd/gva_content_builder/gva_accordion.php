                     ...
                     <div class="panel panel-default">
                        <div class="panel-heading" role="tab">
                           <h4 class="panel-title">
                             <a role="button" data-toggle="collapse" class="button <?php print ($i == 1) ? '' : 'collapsed' ?>" href="#<?php print ($_id . '-' . $i) ?>">
                               <?php print $$title ?>
                             </a>
                           </h4>
                        </div>
                        <div id="<?php print ($_id . '-' . $i) ?>" class="panel-collapse collapse <?php if($i==1) print ' show' ?>" data-parent="#<?php print $_id; ?>">
