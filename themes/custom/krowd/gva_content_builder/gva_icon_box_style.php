...
if(!class_exists('element_gva_icon_box_style')):
   class element_gva_icon_box_style{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $_css = count($css) > 0 ? 'style="' . implode(';', $css) . '"' : '';
         ob_start();
         ?>
         
         <?php if($style == 'style-1' || $style == 'style-2' || $style == 'style-4'){ ?>
            <div class="widget gsc-icon-box-new <?php print $_classes ?>" <?php print $_css ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon || $image){ ?>
