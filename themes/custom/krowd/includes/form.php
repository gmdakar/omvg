...
function krowd_form_contact_message_feedback_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {
...
function krowd_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {
  ...
  if($form_id == 'commerce_product_campaign_add_form' || $form_id == 'commerce_product_campaign_edit_form'){
