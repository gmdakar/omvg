 ...
 *
 * @package Drupal\imagefield_default_alt_and_title
 */
class ImagefieldDefaultAltAndTitleBatch {
   ...
   * {@inheritdoc}
   */
  public static function addedData($data, $type, &$context) {
   ...
   */
  public static function addedDataFinishedCallback($success, $results, $operations) {
    if ($success) {
   ...
   */
  public static function changeValue($fields, $data, $config) {
    $result = [];
